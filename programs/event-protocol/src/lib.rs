...
pub mod event_protocol {
    ...
    pub fn deploy_ns_event(
        ...
        deploy_ns_event::handler(ctx, id, title, description, end_date)
    }

    pub fn deploy_sn_event(
        ...
        deploy_sn_event::handler(ctx, id, title, description, end_date)
    }
